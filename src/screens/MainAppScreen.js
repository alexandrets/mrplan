        ...
        <TouchableOpacity style={styles.menuOverlay} activeOpacity={1} onPress={closeAddTaskModal}>
          <ScrollView contentContainerStyle={styles.scrollContainer}>
            <View style={styles.addTaskModalContent} onStartShouldSetResponder={() => true}>
                  ...
                  <View style={styles.projectSelector}>
                    <TouchableOpacity 
                      style={[
                        ...
                        !newTaskProjectId && styles.projectButtonActive
                      ]} 
                    ...
                    {projects.map(proj => (
                      <TouchableOpacity 
                        ...
                        style={[
                          styles.projectButton, 
                          newTaskProjectId === proj.id && styles.projectButtonActive
                        ]} 
              ...
              <View style={styles.formGroup}>
                <Text style={styles.selectorLabel}>Estimated Time:</Text>
                <ScrollView horizontal showsHorizontalScrollIndicator={false}>
                  <View style={styles.timeSelector}>
                    {timeOptions.map(time => (
                      <TouchableOpacity 
                        ...
                        style={[
                          styles.timeButton, 
                          newTaskTime === time && styles.timeButtonActive
                        ]} 
                        onPress={() => setNewTaskTime(newTaskTime === time ? null : time)}
                      >
                        <Text style={[
                          styles.timeButtonText, 
                          newTaskTime === time && styles.timeButtonTextActive
                        ]}>
