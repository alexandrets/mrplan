...
const styles = StyleSheet.create({
  ...
  fakeInput: { backgroundColor: '#f8f9fa', borderRadius: 8, paddingHorizontal: 15, paddingVertical: 15, minHeight: 50, justifyContent: 'center', borderWidth: 1, borderColor: '#dee2e6', marginBottom: 15 },
  fakeInputText: { fontSize: 16, color: '#495057' },
